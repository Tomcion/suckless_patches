...
static Key keys[] = {
	...
	{ 0,    XF86XK_MonBrightnessUp,            spawn,          SHCMD("dwmblocks_brightness up") },
	{ 0,    XF86XK_MonBrightnessDown,          spawn,          SHCMD("dwmblocks_brightness down") },
	{ 0,    XF86XK_KbdBrightnessUp,            spawn,          SHCMD("kbd_light -u") },
	{ 0,    XF86XK_KbdBrightnessDown,          spawn,          SHCMD("kbd_light -d") },
	{ MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("screenshot") },
	{ MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("open_picture") },
	{ MODKEY|ShiftMask,             XK_b,      spawn,          SHCMD("open_pdf") },
